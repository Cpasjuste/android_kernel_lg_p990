 ...
 */
//20101112, , resolve packet loss problem when ospd transfer big size file or image [START]
...
#endif
//20101112, , resolve packet loss problem when ospd transfer big size file or image [END]
...
//20101112, , resolve packet loss problem when ospd transfer big size file or image
#if defined (CONFIG_USB_SUPPORT_LGE_ANDROID_GADGET)
...
void gserial_cleanup(void)
{
	unsigned	i;
	struct gs_port	*port;
//20100907, , for USB mode switching
#if defined(CONFIG_USB_SUPPORT_LGE_ANDROID_GADGET)
	unsigned long	flags;
#endif
...
//20100925, , for USB mode switching [START]
#if defined(CONFIG_USB_SUPPORT_LGE_ANDROID_GADGET)
	usb_ep_fifo_flush(gser->out);
	usb_ep_fifo_flush(gser->in);
#endif
//20100925, , for USB mode switching [END]
